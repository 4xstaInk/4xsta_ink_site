...
<div class="bg-gradient-to-br  from-blue-900 to-green-900 min-h-screen overflow-auto" id="main">
  <div class="container max-w-5xl mx-32 px-4">
    <div class="w-4/5">
    
      <h1 class="mt-32 text-white text-6xl font-bold">4xsta iNk<br /></h1>
    </div>
    <div class="w-5/6 my-10 ml-6">
      <h3 class="text-gray-300">
        News, Blog & Socialize <br />
        <strong class="text-white">faster Easier Access & Secure Place</strong>
    ...
    <div class="text-white relative">
      <h3 class="text-uppercase font-semibold">Services & Activities</h3>
      <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 sm:gap-5 uppercase">
        ...
        <div class="group flex items-center bg-indigo-900 bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-blue-800 ring-cyan-700 mt-5 cursor-pointer hover:bg-blue-900 hover:bg-opacity-100 transition">
          ...
          <div>
            <span>NEWS</span>
            <span class="text-xs text-blue-300 block">BBC, CNN ...</span>
          </div>
          <div>
            <i class="fa fa-chevron-right opacity-0 group-hover:opacity-100 transform -translate-x-1 group-hover:translate-x-0 block transition"></i>
          </div>
        ...
        <div class="group flex items-center bg-indigo-900 bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-blue-800 ring-cyan-700 mt-5 cursor-pointer hover:bg-blue-900 hover:bg-opacity-100 transition">
          ...
          <div>
            <span>COVID</span>
            <span class="text-xs text-blue-300 block">TOTAL NUMBER </span>
          </div>
          <div>
            <i class="fa fa-chevron-right opacity-0 group-hover:opacity-100 transform -translate-x-1 group-hover:translate-x-0 block transition"></i>
          </div>
        ...
        <div class="group flex items-center bg-indigo-900 bg-opacity-40 shadow-xl gap-5 px-6 py-5 rounded-lg ring-2 ring-offset-2 ring-offset-blue-800 ring-cyan-700 mt-5 cursor-pointer hover:bg-blue-900 hover:bg-opacity-100 transition">
          ...
          <div>
            <span>SOCIAL</span>
            <span class="text-xs text-blue-300 block">REGISTER, LOGIN ...</span>
          </div>
          <div>
            <i class="fa fa-chevron-right opacity-0 group-hover:opacity-100 transform -translate-x-1 group-hover:translate-x-0 block transition"></i>
          </div>
